    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-40 md:w-80 h-40 md:h-80 bg-lagrange-node/5 rounded-full blur-3xl" />
        </div>
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          >
            ...
            >
              <div className="w-16 h-16 md:w-24 md:h-24 mx-auto rounded-full border-2 border-primary/30 flex items-center justify-center animate-glow-pulse">
                <span className="text-3xl md:text-5xl font-serif text-primary">λ</span>
              </div>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl lg:text-2xl text-muted-foreground font-serif mb-3 md:mb-4 leading-relaxed px-4 md:px-0"
            >
            ...
            <motion.p
              ...
              className="text-base md:text-lg text-muted-foreground/70 font-serif mb-8 md:mb-12 italic px-4 md:px-0"
            >
            ...
            >
              <Button
                asChild
                size="lg"
                className="font-serif text-base md:text-lg gap-2 bg-primary text-primary-foreground hover:bg-primary/90"
              >
                <Link to="/map">
                  Explorar el Mapa
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="font-serif text-base md:text-lg border-border hover:bg-secondary"
              >
                <Link to="/lab">
      ...
      <section className="py-12 md:py-24 px-4 md:px-6 border-t border-border/50">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-6">
            {[
              ...
              <motion.div
                ...
                className={`p-4 md:p-6 rounded-xl border ${eje.color} text-center hover:scale-105 transition-transform cursor-pointer`}
              >
                <h3 className="font-serif text-sm md:text-lg text-foreground mb-1">
                  {eje.label}
                </h3>
